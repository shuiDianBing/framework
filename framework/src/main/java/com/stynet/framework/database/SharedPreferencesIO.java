package com.stynet.framework.database;
...
/**
 * Created by shuiDianBing on 16:24.
...
public class SharedPreferencesIO {
    ...
    public SharedPreferencesIO(Context context,String fileName) {
    ...
    public boolean inBool(String key){
