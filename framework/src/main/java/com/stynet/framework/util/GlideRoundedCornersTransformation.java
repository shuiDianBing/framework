...
/**
 * Created by shuiDianBing on 11:46.
 * Refer to the website <<
 * Glide输出指定位置圆角,解决ImageView设置scanType="centerCrop"无效(完美解决) https://www.jianshu.com/p/b749a56eff32
 * 一个Android转换库，为Glide提供各种图像转换 https://github.com/wasabeef/glide-transformations
 * Android 开发 框架系列 glide-transformations 图片处理基本使用  https://www.cnblogs.com/guanxinjing/p/9708581.html
 * QQ << 1226085282 &  Email << 1226085282@qq.com
 * function << glide 输出指定圆角
 */
public class GlideRoundedCornersTransformation extends BitmapTransformation {
    ...
    public enum CornerType {
        ...
        OTHER_LEFT_TOP, OTHER_RIGHT_TOP, OTHER_RIGHT_BOTTOM,OTHER_LEFT_BOTTOM,
        DIAGONAL_FROM_LEFT_TOP, DIAGONAL_FROM_RIGHT_TOP
    }
    ...
    public GlideRoundedCornersTransformation(int radius, int margin) {
     ...
     */
    public GlideRoundedCornersTransformation(int radius, int margin, CornerType cornerType) {
        this.radius = radius;
    ...
    private void drawRoundRect(Canvas canvas, Paint paint, float width, float height) {
        ...
        switch (cornerType) {
            ...
            case OTHER_LEFT_TOP:
                ...
                break;
            case OTHER_RIGHT_TOP:
                drawOtherTopRightRoundRect(canvas, paint, right, bottom);
                break;
            case OTHER_LEFT_BOTTOM:
                drawOtherBottomLeftRoundRect(canvas, paint, right, bottom);
                break;
            case OTHER_RIGHT_BOTTOM:
    ...
    public boolean equals(Object o) {
        return o instanceof GlideRoundedCornersTransformation &&
                ((GlideRoundedCornersTransformation) o).radius == radius &&
                ((GlideRoundedCornersTransformation) o).diameter == diameter &&
                ((GlideRoundedCornersTransformation) o).margin == margin &&
                ((GlideRoundedCornersTransformation) o).cornerType == cornerType;
    }
